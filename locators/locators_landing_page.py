...
class Testlocators:
    Button_make_order_header = (By.XPATH, '//div[contains(@class, "Header_Nav__AGCXC")]/button[text() = "Заказать"]')
    Button_make_order_landing = By.XPATH, '//div[contains(@class, "Home_FinishButton")]/button[text()="Заказать"]'
