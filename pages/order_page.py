...
class OrderPage(BasePage):
    ...
    def click_on_element_make_order_header(self, button: object):
    ...
    def fill_name_field(self):
        self.find_element_with_wait(Oder_page_locators.INPUT_NAME).send_keys(Person.name)

    @allure.step('Заполняем поля "Фамилия"')
    def fill_surname_field(self):
        self.find_element_with_wait(Oder_page_locators.INPUT_LASTNAME).send_keys(Person.lastname)
